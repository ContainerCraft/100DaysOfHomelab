...
sudo dnf remove -y zram-generator-defaults cockpit # disable swap & webui console
sudo dnf install -y openvswitch libibverbs openvswitch-devel NetworkManager-tui NetworkManager-ovs keepalived haproxy dnf-automatic kata-containers util-linux python3 python3-pip screenfetch glances lm_sensors iptables htop tmux lvm2 vim git tar
